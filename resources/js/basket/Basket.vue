            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" name="first_names" v-model="customer.first_name">
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" name="address" v-model="customer.street">
                    </div>
                    <div class="col-md-6 form-group">
